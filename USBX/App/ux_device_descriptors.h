...
typedef struct {
  ...
  uint8_t bReserved;
    ...
    (USBD_RNDIS_CLASS_ACTIVATED == 1) || (USBD_CDC_ECM_CLASS_ACTIVATED == 1)
typedef struct {
...
#endif /* (USBD_CDC_ACM_CLASS_ACTIVATED == 1) || (USBD_RNDIS_CLASS_ACTIVATED   \
...
uint16_t USBD_Get_Configuration_Number(uint8_t class_type,
